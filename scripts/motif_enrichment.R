...
main = function(fimo_pval, fdr_cutoff, condition, control,
                in_fimo_pos, in_fimo_neg, upstream,
                out_path, out_meta, out_heatmap, out_plot){
    ...
    plot = ggplot() +
        ...
        ggtitle(paste0("motif enrichment upstream of ", condition, " vs. ", control),
